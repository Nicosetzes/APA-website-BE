...
const fixture = (lotteryArray, playerArray) => {
    ...
    const concertMatch = (randomTeamOne, randomTeamTwo) => {
        if (!randomTeamOne && !randomTeamTwo) {
            ...
            let firstIndex =
                teamsThatHaveNotPlayedThisWeek.indexOf(randomTeamOne)
            console.log(
                `Elimino ${randomTeamOne.team} en la posición ${firstIndex}`
            )
            console.log(
            ...
            let secondIndex =
                teamsThatHaveNotPlayedThisWeek.indexOf(randomTeamTwo)
            console.log(
